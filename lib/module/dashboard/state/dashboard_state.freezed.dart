...
mixin _$DashboardState {
  ...
  set counter(int value) =>
      throw _privateConstructorUsedError; //nanti tidak bikin disini karena disini untuk data dumy
...
class _$DashboardStateImpl implements _DashboardState {
  ...
  @JsonKey()
  int counter;
//nanti tidak bikin disini karena disini untuk data dumy
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'DashboardState(counter: $counter, products: $products)';
  }
...
abstract class _DashboardState implements DashboardState {
  factory _DashboardState({int counter, List<dynamic> products}) =
      _$DashboardStateImpl;

  @override
  int get counter;
  set counter(int value);
  @override //nanti tidak bikin disini karena disini untuk data dumy
  List<dynamic>
      get products; //nanti tidak bikin disini karena disini untuk data dumy
